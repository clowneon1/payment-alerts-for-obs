...
const cmd = `"${bunExe}" build "${serverJs}" --compile --target bun-windows-x64 --windows-title "StreamPe" --windows-publisher "clowneon1" --windows-description "StreamPe Server" --windows-copyright "Copyright (c) 2026 clowneon1" --windows-version "2.2.4.0" --windows-icon "${iconIco}" --windows-hide-console --outfile "${outExe}"`;
console.log('>', cmd);
